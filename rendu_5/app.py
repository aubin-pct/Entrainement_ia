...
for a in activations:
    ...
    train_accuracies, test_accuracies = p_serie.fit(x_train, y_train, epochs=epochs, alpha=0.05, x_test=x_test, y_test=y_test)
...
for a in activations:
    ...
    train_accuracies, test_accuracies = p_para.fit(x_train, y_train, epochs=epochs, alpha=0.05, x_test=x_test, y_test=y_test)
